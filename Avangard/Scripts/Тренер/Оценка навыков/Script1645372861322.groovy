...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/span_home'))

'Кнопка редактировать'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/edit home'))
...
'Оценка 10'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/span_10'))

'Оценка 9'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/span_9'))

'Добавить'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button add1'))

'Вставка в цель текста'
WebUI.setText(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/input__title1'), 'автотест1')
...
'Добавить в фокусе'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button_add in focus'))

'Кнопка добавить 2 строка'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button_add2'))

'Ввод текст в цель'
WebUI.setText(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/input__title1'), 'тест')
...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/edit3'))
...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button_save_focuse2'))
...
'Смотреть отчет'
WebUI.scrollToElement(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/report home'), 
    0)

'Смотреть отчет'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/report home'))
...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/div_10'))
...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button_close'))
...
'Удалить 1 фокус'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/editf'))

'Удалить фокус развития'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button_delete'))

'Подтверждение'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Тренер)/Case (Оценка навыков)/button_delete2'))
