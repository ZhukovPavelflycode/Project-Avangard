...
'Ниже проверки под игроком'
WebUI.callTestCase(findTestCase('Игрок/Авторизация'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('Object Repository/Avangard New/Object (Тренер)/div_19.02.22'), 0)

WebUI.verifyTextPresent('тестовая задача', false)

not_run: WebUI.enhancedClick(findTestObject('Object Repository/Avangard New/Object (Тренер)/span_ _sc-drKuOJ cOdKkH CheckboxDisplayWithoutName'))
