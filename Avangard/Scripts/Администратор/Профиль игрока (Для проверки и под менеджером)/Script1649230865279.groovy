...
if (WebUI.verifyElementText(findTestObject('Avangard New/Object (Администратор)/Case (Профиль игрока)/role admin'), 'Администратор', 
    ...
    WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/students'))

    WebUI.setText(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/input'), GlobalVariable.player_for_test_1)
    ...
    while (WebUI.verifyElementVisible(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/editProfile'), 
        ...
        WebUI.scrollToElement(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/input__phone'), 
            0)

        'Очистка поля номера телефона'
        WebUI.clearText(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/input__phone'), 
            FailureHandling.STOP_ON_FAILURE)

        'Ввод номера телефона\r\n'
        WebUI.setText(findTestObject('Object Repository/admin/students/Page_/input__phone'), '8 (953) 456-78-91')

        WebUI.scrollToElement(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/Save_button_'), 
            0)

        'Сохранение изменений'
        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/Save_button_'))

        WebUI.verifyTextPresent('Пользователь сохранен', false)

        'Архивация игрока'
        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/arch_button'))

        'Кнопка Архиваровать'
        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/confirm_arch_button'))
        ...
        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/arch_player'))

        WebUI.scrollToElement(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/global_player'), 
            0)

        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/global_player'))
        ...
        'Возврат из архива'
        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/recovery_player'))

        'Подтверждение восстановления'
        WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/confirm_recovery'))
...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_predstaviteli'))

WebUI.verifyElementText(findTestObject('Avangard New/Object (Администратор)/Case (Профиль игрока)/string family'), 'СЕМЬЯ')

'Вкладка Статусы'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_status'))

'Вкладка Игры'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_game'))
...
'Вкладка Рейтинг '
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_rank'))
...
'Вкладка Статистика'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_stat'))

WebUI.verifyElementText(findTestObject('Avangard New/Object (Администратор)/Case (Профиль игрока)/div_math'), 'Матчи')

'Вкладка Оценка игр'
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_game grade'))
...
WebUI.click(findTestObject('Object Repository/Avangard New/Object (Администратор)/Case (Профиль игрока)/button_grade naviki'))
