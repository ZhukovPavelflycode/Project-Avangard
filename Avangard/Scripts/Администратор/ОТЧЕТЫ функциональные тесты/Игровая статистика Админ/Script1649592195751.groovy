...
WebUI.sendKeys(findTestObject('Object Repository/Avangard New/Object (Администратор)/Сase (Игровая статистика)/input__school game stat'), 
...
WebUI.sendKeys(findTestObject('Object Repository/Avangard New/Object (Администратор)/Сase (Игровая статистика)/input__team school game'), 
    Keys.chord(Keys.ENTER))
