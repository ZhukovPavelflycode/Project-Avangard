...
WebUI.click(findTestObject('admin/teachers/Page_/teach'))

'профиль тренера Агеев '
WebUI.click(findTestObject('admin/teachers/Page_/span_'))

WebUI.verifyTextPresent('ПРОФИЛЬ ПРЕПОДАВАТЕЛЯ', false)

'переход на вкладку карьера '
WebUI.click(findTestObject('admin/teachers/Page_/career'))
...
WebUI.click(findTestObject('admin/teachers/Page_/button_'))

WebUI.verifyTextPresent('Пользователь сохранен', false)

'переход на главную '
WebUI.click(findTestObject('admin/teachers/Page_/root'))
