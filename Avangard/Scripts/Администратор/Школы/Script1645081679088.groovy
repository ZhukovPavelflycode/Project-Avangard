...
WebUI.click(findTestObject('Object Repository/admin/school/schools/schools'))

WebUI.takeFullPageScreenshot(('C:\\scr\\' + GlobalVariable.school) + '43.jpg')

'выбор Академия "Авангард" и переход к расписанию школы\r\n'
WebUI.click(findTestObject('Object Repository/admin/school/Page_/div_'))

'переход на вкладку игроков'
WebUI.scrollToElement(findTestObject('Object Repository/admin/school/Page_/players'), 0)

'переход на вкладку игроков'
WebUI.click(findTestObject('Object Repository/admin/school/Page_/players'))

WebUI.takeFullPageScreenshot(('C:\\scr\\' + GlobalVariable.school) + '44.jpg')

'переход на вкладку команд'
WebUI.click(findTestObject('Object Repository/admin/school/Page_/team'))

WebUI.takeFullPageScreenshot(('C:\\scr\\' + GlobalVariable.school) + '45.jpg')

'выбр команды ОМСКИЕ ЯСТРЕБЫ \r\n'
WebUI.click(findTestObject('Object Repository/admin/school/Page_/omsk'))

'переход на вкладку редактирование '
WebUI.click(findTestObject('Object Repository/admin/school/Page_/edit'))

WebUI.takeFullPageScreenshot(('C:\\scr\\' + GlobalVariable.school) + '47.jpg')

'переход на вкладку все игроки\r\n'
WebUI.click(findTestObject('Object Repository/admin/school/Page_/allplayer'))

WebUI.takeFullPageScreenshot(('C:\\scr\\' + GlobalVariable.school) + '48.jpg')

'переход на вкладку занятие команды\r\n'
WebUI.click(findTestObject('Object Repository/admin/school/Page_/groups'))
