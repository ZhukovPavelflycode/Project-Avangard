...
WebUI.click(findTestObject('Avangard New/Object (Игрок)/Case (Оценка навыков)/span_1'))
...
'Вкладка Отчеты'
WebUI.click(findTestObject('Avangard New/Object (Игрок)/Case (Оценка навыков)/report'))

'Отчеты по навыкам'
WebUI.click(findTestObject('Avangard New/Object (Игрок)/Case (Оценка навыков)/repor skill'))
...
'Поставить оценку 8'
WebUI.click(findTestObject('Avangard New/Object (Игрок)/Case (Оценка навыков)/span_8'))
