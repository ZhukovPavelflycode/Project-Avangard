...
'Вкладка отчеты'
WebUI.click(findTestObject('Avangard New/Object (Игрок)/Case (Отчеты по навыкам)/span_reports'))

'Отчет по навыкам'
WebUI.click(findTestObject('Avangard New/Object (Игрок)/Case (Отчеты по навыкам)/div_report_skills'))

WebUI.verifyElementText(findTestObject('Avangard New/Object (Игрок)/Case (Отчеты по навыкам)/div_8'), '8')

'Проверка имени'
WebUI.verifyElementText(findTestObject('Avangard New/Object (Игрок)/Case (Отчеты по навыкам)/div_name'), 
